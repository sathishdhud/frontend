...
import { CalendarIcon, UserIcon, PhoneIcon, EnvelopeIcon } from '@heroicons/react/24/outline';
...
const Reservations: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert(`Error: ${error.response?.data?.message || 'Failed to create reservation'}`);
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="space-y-6">
        ...
        {isCreating ? (
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">Manage Reservations</h2>
            <p className="text-gray-500">Reservation management features will be implemented here.</p>
          </div>
        )}
      </div>
    </Layout>
